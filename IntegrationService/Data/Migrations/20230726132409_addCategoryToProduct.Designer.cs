...
namespace IntegrationService.Data.Migrations
{
    ...
    [Migration("20230726132409_addCategoryToProduct")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IntegrationService.Models.Collection.Collection", b =>
                {
                    ...
                    b.HasKey("Sku", "StoreCode", "ChannelId");
            ...
            modelBuilder.Entity("IntegrationService.Models.Nutritions.Nutrition", b =>
                {
                    ...
                    b.Property<string>("FirstCell")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FourthCell")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("IntegrationService.Models.Nutritions.NutritionProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("IntegrationService.Models.User.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = "bd7108c3-e357-4df1-ac75-1b9eedb6003a",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6fed6a16-aaf4-4eee-8e0e-c2e657976fc8",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            UserId = "d20e2c4e-875a-4a5b-9423-3e74bc68d01b",
                            ClaimType = "IsAdmin",
                            ClaimValue = "true",
                            Id = 1
                        });
            ...
            modelBuilder.Entity("IntegrationService.Models.Nutritions.NutritionProduct", b =>
                {
                    b.HasOne("IntegrationService.Models.Nutritions.Nutrition", "Nutrition")
                        .WithMany()
